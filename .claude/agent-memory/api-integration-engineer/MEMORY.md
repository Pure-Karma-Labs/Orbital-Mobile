...
- [Issue #95 wrapped key contract](project_issue95_wrapped_key_contract.md) — encryptedGroupKey->wrappedGroupKey rename, new pending-wraps endpoints, wrappedBy semantics
- [Identity key formats](project_identity_key_formats.md) — DJB keys (getPreKeyBundle) vs JWK keys (profile); wrong format causes silent ECIES failures
