...
- [Zustand store architecture — Issue #7](project_zustand_stores.md) — Single useAppStore, 7 slices (added notificationSlice), MMKV persistence, deferred init, useShallow selector hooks
...
- [Media FK constraint retry](feedback_media_fk_constraint.md) — saveMedia catches FK errors, retries with null parent IDs; threads not always in local DB
