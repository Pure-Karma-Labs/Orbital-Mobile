...
| XEdDSA (Ed25519) | Sender authentication in ECIES envelopes | `curve25519-dalek` 5.0 (Rust, stock crates.io since libsignal v0.99.1; previously Signal's `signal-curve25519-4.1.3` fork) | `packages/orbital-signal/rust/orbital_signal/src/ecies.rs` |
...
| Signal Protocol | Double Ratchet, X3DH, Sealed Sender | `libsignal-protocol` v0.99.1 (Rust, via uniffi) | `packages/orbital-signal/` |
