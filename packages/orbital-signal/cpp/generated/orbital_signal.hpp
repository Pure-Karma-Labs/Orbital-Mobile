...
class NativeOrbitalSignal : public jsi::HostObject {
  ...
  protected:
    ...
    jsi::Value cpp_uniffi_orbital_signal_fn_func_hello_orbital(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
    jsi::Value cpp_uniffi_orbital_signal_checksum_func_hello_orbital(jsi::Runtime& rt, const jsi::Value& thisVal, const jsi::Value* args, size_t count);
