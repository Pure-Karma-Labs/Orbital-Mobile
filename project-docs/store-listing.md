...
- Per-version "What's New" drafts live in `project-docs/release-notes/<version>.md` (tracked, same as this file); this document holds only the evergreen listing copy.
